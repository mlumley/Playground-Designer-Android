...
public class GroundManager : MonoBehaviour {
    ...
    public void changeXSize(string XSize) {
        ...
        tiles.GetComponent<Renderer>().material.mainTextureScale = new Vector2(x * 10, tiles.GetComponent<Renderer>().material.mainTextureScale.y);
    }
    ...
    public void changeZSize(string ZSize) {
        ...
        tiles.GetComponent<Renderer>().material.mainTextureScale = new Vector2(tiles.GetComponent<Renderer>().material.mainTextureScale.x, z * 10);
    }
}
